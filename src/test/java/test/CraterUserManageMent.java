...
//		  loginpage.loginButton.click();
		  ...
		  utils.waitUntilElementVisible(dashboardPage.amountDueText);
...
//			  loginpage.password.sendKeys(password);
			  utils.sendKeysWithActionsClass(loginpage.useremail, useremail);
			  utils.sendKeysWithActionsClass(loginpage.password, password);
			  loginpage.loginButton.click();
